      ...
      <div className="w-full max-w-md rounded-2xl border border-surface bg-surface p-8 shadow-md">
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-5">
          <div className="space-y-2">
            <Label htmlFor="name" className="font-medium text-sm ml-1">
              Full Name
            </Label>
            <Input
              id="name"
          ...
          <div className="space-y-2 relative">
            <Label htmlFor="password" className="font-medium text-sm ml-1">
              Password
            </Label>
          ...
          <div className="space-y-2">
            <Label className="font-medium text-sm ml-1">Profession</Label>
            <PillSelect
              value={profession}
